...
const Submissions = () => {
    ...
    <div style={style}>
        ...
        Hello, potential Excuse Me Mag author!</h3>
        ...
        <br></br>
        <h3 className='playfair-font'>Hello, potential Excuse Me Mag poet!</h3>
        <h3> SUBMISSIONS ARE CURRENTLY OPEN!</h3>
        <br></br>
        ...
        <br></br>
        <h3 className='playfair-font'>Hello, potential Excuse Me Mag artist!</h3>
        <h3> SUBMISSIONS ARE CURRENTLY OPEN!</h3>
        <br></br>
